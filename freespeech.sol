...
contract FreeSpeech is Context, IERC20, Ownable
{
    ...
    uint256 private _tTotal = 100_000_000 * 10**9; //100 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Free Speech";
    string private _symbol = "1AMD";
    ...
    uint256 public totalBuyFee = _taxFee.add(_liquidityFee).add(_marketingFee).add(_TeamFee); //5% Total Buy Fee
    
    
    

    address payable public marketingWallet =  payable(0x20F9e6eAA0A93f06C376cCCF309e3f74c7267986);
    address payable public TeamWallet =  payable(0x3E26eFE31bbd7EDAb220d24bD7Aa919bfa849db3);
    ...
    constructor () 
    {
        ...
        _isExcludedFromWhale[TeamWallet]=true;
    ...
    {
        uint256 allFee = _liquidityFee.add(_marketingFee).add(_TeamFee);
