...
contract FreeSpeech is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0x6cb49E0E5B7Eb7De63DDB8ACe574Bf2D832EA291); // Marketing Wallet Address
    address payable public teamWalletAddress =
        payable(0x3DE62A8D6040480A57599BC240C0315E0d2B6014); // team Wallet Address
    address public constant deadWallet =
        0x000000000000000000000000000000000000dEaD;
    address private freespeechDeployer = 0x3B938deC37857627bb6A26B87E7C4d3Fa5709368;
    ...
    string private constant _symbol = "1amd";
    ...
    constructor() {
        require(msg.sender == freespeechDeployer, "Your not the deployer of this contract");
    ...
    function swapAndLiquify() public lockTheSwap {
        ...
        transferToAddressETH(teamWalletAddress, ethForteam);
    ...
    function setteamWalletAddress(address _teamWallet) external onlyOwner {
        ...
        teamWalletAddress = payable(_teamWallet);
        emit AuditLog("We have Updated the teamWallet:", teamWalletAddress);
    }
